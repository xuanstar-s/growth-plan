...
Add an iPhone-first photo flow to the "控糖计划" app so the user can take a food photo, choose a food category, see an estimated sugar risk and sugar range, then write the result into today's sugar-control record.
